...
%         signal_pass_channel_correct = signal_send;
...
%         signal_ori_resyn = signal_received_aftercorrect(fin_syn_point_real_send1:end);
%         fin_syn_point_forcorrect = ruo_signal_syn_recorrect(signal_ori_resyn,signal_received_real_send2,fin_syn_point_real_send2);
